...
google.bookmarkbubble.Bubble.prototype.msg = {
  android: 
    'Lägg till denna webbapplikation på din android: tryck på och därefter Lägg till på hemskärmen.',
  android3: 
    'Lägg till denna webbapplikation på din android: tryck på <img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_ANDROID3_BOOKMARK_DATA_URL_ +'" style="height: 1.5em;display: inline-block;padding:0;margin:0;" />, och därefter Lägg till på hemskärmen.',
  android4: 
    'Lägg till denna webbapplikation på din android: tryck på <img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_ANDROID4_MOBILE_BOOKMARK_DATA_URL_ +'" style="height: 1.5em;display: inline-block;padding:0;margin:0;" />, och därefter Lägg till på hemskärmen.',
  blackberry: 
    'Lägg till denna webbapplikation på din blackberry: tryck på <img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_BLACKBERRY_ICON_DATA_URL_ +'" style="height: 1em;display: inline-block;padding:0;margin:0" />, och därefter Lägg till på hemskärmen.',
  playbook: 
     'Lägg till denna webbapplikation på din playbook: tryck på <img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_PLAYBOOK_BOOKMARK_DATA_URL_ +'" style="height: 1.5em;display: inline-block;padding:0;margin:0;" />, och därefter Lägg till på hemskärmen.',
  ios42orlater :
     'Lägg till denna webbapplikation på din smartphone: tryck på <img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_SAFARI_FORWARD_DATA_URL_ +'" style="height: 1em;display: inline-block;padding: 0;margin: 0" /> och därefter Lägg till på hemskärmen.',
  ioslegacy: 'Lägg till denna webbapplikation på din smartphone: tryck på och därefter Lägg till på hemskärmen.'
};
